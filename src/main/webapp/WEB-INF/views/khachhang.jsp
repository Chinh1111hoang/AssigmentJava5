...
<div class="d-flex justify-content-center mt-3">
    <div class="col-md-8 account-info" style="background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); height: 550px;">
        ...
        <form action="${pageContext.request.contextPath}/khachhang/save" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="hoTen" class="form-control" value="${khachHang.hoTen}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="trangThai" value="Active" ${khachHang.trangThai == 'Active' ? 'checked' : ''}>
                    <label class="form-check-label">Active</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="trangThai" value="UnActive" ${khachHang.trangThai == 'UnActive' ? 'checked' : ''}>
    ...
    <table class="table" style="background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <c:forEach var="kh" items="${listKH}">
            <tr>
                ...
                <td>${kh.ngaySua}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/khachhang/edit/${kh.id}" class="btn btn-primary btn-sm">Sửa</a>
                    <a href="${pageContext.request.contextPath}/khachhang/delete/${kh.id}" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xóa danh mục này?');">Xóa</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
